  ...
  <div class="modal-sec">
    <div class="crypto">
      <div
        ...
        v-for="(cryptocurrency, name, index) in balanceClient"
        :key="index"
      >
        <div>
          <img
          ...
          <img
            ...
            alt=""
          />
          <div class="balance__price-info">
            <span> {{ name }} </span>
            <div class="price">{{ cryptocurrency }}</div>
          </div>
        </div>
        <button type="button" @click="openAddCoins(cryptocurrency, name)">
          +
        </button>
      </div>
    </div>
    ...
    <div class="operation">
      <div class="personal-funds">
        <div class="title-row">
          <div class="title">
            Turnover of personal funds<a class="title-img" href="#"
        ...
        <div class="value">
          <img class="value-img" src="../assets/img/usd.png" alt="usd" /><img
            class="value-img__hidden"
            width="32"
            height="32"
            src="../assets/img/usd-mob.png"
            alt="usd"
          />
          {{ clientData.total_turnover }}
        </div>
      </div>
      <div class="structure-funds">
        <div class="title-row">
          <div class="title">
            Structure funds turnover<a class="title-img" href="#"
              ><img src="../assets/img/alert-circle.svg" alt=""
            /></a>
          </div>
...
<script>
  ...
  export default {
    computed: {
      ...mapGetters({
        balanceClient: 'clientsDetails/balanceData',
        clientData: 'clientsDetails/clientData',
      }),
    },
    methods: {
      openAddCoins(cryptocurrency, name) {
        this.$emit('openAddCoins', cryptocurrency, name);
      },
    },
  };
</script>
