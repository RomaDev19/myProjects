  ...
  <div class="modal">
    <div class="modal-body">
      <div class="modal-header">
        ...
        <h1>Edit pool</h1>
        <span class="close" @click="closeEditPool()"
      ...
      <div class="modal-btn">
        <button @click="editPool(), closeEditPool()">Save</button>
      </div>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapActions({
        editsPool: 'pool/editPool',
      }),
      closeEditPool() {
        this.$emit('closeEditPool');
      },
      pushMethod(coins) {
      ...
      editPool() {
        ...
        let poolEditObj = {
          ...
          poolEdit: {
            ...
            amount: this.amounts,
            exp_time: date.toISOString().split('T')[0],
          },
        };
        this.editsPool(poolEditObj);
      },
    },
    mounted() {
      this.full_name = this.moreData.name;
      this.amounts = this.moreData.amount;
      this.lifetimes = this.moreData.lifetime;
      this.percents = this.moreData.percent;
    },
  };
</script>
