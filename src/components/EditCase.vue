  ...
  <div class="modal">
    ...
    <div class="modal-body">
      <div class="modal-header">
        ...
        <h1>Edit case</h1>
        <span class="close" @click="closeEditCase()"
      ...
      <div class="modal-sec">
        <div class="info-tab">
          <div class="info__method">
            ...
            <input id="info__method" type="text" v-model="coinsName" />
            <div>
          ...
          <div class="case__interval-fake">
            <label for="case__interval-fake">Lifetime (Day) </label>
            <input id="case__interval-fake" type="number" v-model="days" />
          </div>

          <div class="case__profit">
            <label for="case__profit">Percent</label>
            <input id="case__profit" type="number" v-model="percent" />
          </div>
        </div>
      </div>
      <div class="modal-btn">
        <button @click="editCase(), closeEditCase()">Save</button>
      </div>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      closeEditCase() {
        this.$emit('closeEditCase');
      },
    },
    mounted() {
      this.coinsName = this.moreData.name;
      this.days = this.moreData.lifeTime;
      this.percent = this.moreData.percents;
      this.idEdit = this.moreId + 1;
    },
  };
</script>
